...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		<!--[if IE 7]>
		  <link rel="stylesheet" href="static/houtai/assets/css/font-awesome-ie7.min.css" />
		<![endif]-->
        <!--[if lte IE 8]>
		  <link rel="stylesheet" href="static/houtai/assets/css/ace-ie.min.css" />
		<![endif]-->
       ...
       <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='static/houtai/assets/js/jquery-2.0.3.min.js'>"+"<"+"/script>");
		</script>
		<!-- <![endif]-->
		<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='static/houtai/assets/js/jquery-1.10.2.min.js'>"+"<"+"/script>");
</script>
<![endif]-->
        ...
        <script src="static/houtai/static/houtai/js/lrtk.js" type="text/javascript" ></script>
<title>分类管理</title>
</head>
