...
<title>网站后台管理系统 </title>
		...
		<link rel="stylesheet" href="static/houtai/assets/css/ace-rtl.min.css" />
		<link rel="stylesheet" href="static/houtai/assets/css/ace-skins.min.css" />
        <link rel="stylesheet" href="static/houtai/css/style.css"/>
		<!--[if lte IE 8]>
		  <link rel="stylesheet" href="assets/css/ace-ie.min.css" />
		<![endif]-->
		<script src="static/houtai/assets/js/ace-extra.min.js"></script>
		<!--[if lt IE 9]>
		...
		<script type="text/javascript">
			if("ontouchend" in document) document.write("<script src='static/houtai/assets/js/jquery.mobile.custom.min.js'>"+"<"+"script>");
		</script>
		...
		<![endif]-->
		<script src="static/houtai/assets/js/ace-elements.min.js"></script>
		<script src="static/houtai/assets/js/ace.min.js"></script>
        ...
        <script src="static/houtai/js/jquery.nicescroll.js" type="text/javascript"></script>
			...
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					<a href="#" class="navbar-brand">
						<small>
						 <!-- <img src="static/houtai/images/logo.png" width="470px">
						  --></small>
					</a><!-- /.brand -->
				</div><!-- /.navbar-header -->
					...
					<ul class="nav nav-list" id="nav_list">
                     ...
                     <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 产品管理 </span><b class="arrow icon-angle-down"></b></a>
					   <ul class="submenu">
						 ...
						 <li class="home"><a  href="javascript:void(0)" name="Brand_Manage.jsp" title="品牌管理"  class="iframeurl"><i class="icon-double-angle-right"></i>品牌管理</a></li>
                        ...
                        <li><a href="#" class="dropdown-toggle"><i class="icon-group"></i><span class="menu-text"> 管理员管理 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
                                ...
                                <li class="home"><a href="javascript:void(0)" name="administrator.html" title="管理员列表" class="iframeurl"><i class="icon-double-angle-right"></i>管理员列表</a></li>
								  <li class="home"><a href="javascript:void(0)" name="admin_info.do" title="个人信息" class="iframeurl"><i class="icon-double-angle-right"></i>个人信息</a></li>
							</ul>
						</li>
					</ul>
					</div>
