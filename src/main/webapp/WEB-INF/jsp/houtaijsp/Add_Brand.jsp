...
<title>添加品牌</title>
        ...
        <script type="text/javascript" src="static/houtai/Widget/swfupload/swfupload.js"></script>
        <script type="text/javascript" src="static/houtai/Widget/swfupload/swfupload.queue.js"></script>
        <script type="text/javascript" src="static/houtai/Widget/swfupload/swfupload.speed.js"></script>
        <script type="text/javascript" src="static/houtai/Widget/swfupload/handlers.js"></script>
</head>
<body>
<div class=" clearfix">
...
$(document).ready(function() {
	var settings = {
		flash_url : "static/houtai/Widget/swfupload/swfupload.swf",
		flash9_url : "static/houtai/Widget/swfupload/swfupload_fp9.swf",
		...
		debug: false,
		// Button settings
		button_image_url: "static/houtai/Widget/swfupload/upload-btn.png",
		button_width: "95",
		button_height: "30 ",
