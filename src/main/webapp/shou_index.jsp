...
<script>
	...
	<link href="static/css/receptionCss/bootstrap.css" rel='stylesheet' type='text/css' />
	<link href="static/css/receptionCss/login_overlay.css" rel='stylesheet' type='text/css' />
	<link href="static/css/receptionCss/style6.css" rel='stylesheet' type='text/css' />
	<link rel="stylesheet" href="static/css/receptionCss/shop.css" type="text/css" />
	<link rel="stylesheet" href="static/css/receptionCss/owl.carousel.css" type="text/css" media="all">
	<link rel="stylesheet" href="static/css/receptionCss/owl.theme.css" type="text/css" media="all">
	<link href="static/css/receptionCss/style.css" rel='stylesheet' type='text/css' />
	<link href="static/css/receptionCss/fontawesome-all.css" rel="stylesheet">
...
<body>
									...
									<div class="row">
										...
										<div class="col-md-4 media-list span4 text-left">
											...
											<div class="media-mini mt-3">
												<a href="shop.html">
													<img src="static/images/receptionImg/g2.jpg" class="img-fluid" alt="">
												</a>
											</div>
										</div>
										<div class="col-md-4 media-list span4 text-left">
											...
											<div class="media-mini mt-3">
												<a href="shop.html">
													<img src="static/images/receptionImg/g3.jpg" class="img-fluid" alt="">
												</a>
											</div>
								...
								<li>
									<div class="row">
										...
										<div class="col-md-4 media-list span4 text-left">
											...
											<div class="media-mini mt-3">
												<a href="shop.html">
													<img src="static/images/receptionImg/g1.jpg" class="img-fluid" alt="">
												</a>
											</div>
				...
				<div class="row">
						...
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="static/images/receptionImg/s1.jpg" class="img-fluid" alt="">
					...
					<div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="static/images/receptionImg/s2.jpg" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
					...
					<div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="static/images/receptionImg/s3.jpg" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
					...
					<div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="static/images/receptionImg/s4.jpg" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
				...
				<div class="row mt-lg-3 mt-0">
					...
					<div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="static/images/receptionImg/m1.jpg" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
					...
					<div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="static/images/receptionImg/m2.jpg" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
					...
					<div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="static/images/receptionImg/m3.jpg" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
					...
					<div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="static/images/receptionImg/m4.jpg" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
								...
								<div class="gd-box-info text-center">
									<div class="product-men women_two bot-gd">
										<div class="product-googles-info slide-img googles">
											<div class="men-pro-item">
												<div class="men-thumb-item">
													<img src="static/images/receptionImg/s5.jpg" class="img-fluid" alt="">
													<div class="men-cart-pro">
														<div class="inner-men-cart-pro">
															<a href="single.html" class="link-product-add-cart">Quick View</a>
														</div>
								...
								<div class="gd-box-info text-center">
									<div class="product-men women_two bot-gd">
										<div class="product-googles-info slide-img googles">
											<div class="men-pro-item">
												<div class="men-thumb-item">
													<img src="static/images/receptionImg/s6.jpg" class="img-fluid" alt="">
													<div class="men-cart-pro">
														<div class="inner-men-cart-pro">
															<a href="single.html" class="link-product-add-cart">Quick View</a>
														</div>
								...
								<div class="gd-box-info text-center">
									<div class="product-men women_two bot-gd">
										<div class="product-googles-info slide-img googles">
											<div class="men-pro-item">
												<div class="men-thumb-item">
													<img src="static/images/receptionImg/s7.jpg" class="img-fluid" alt="">
													<div class="men-cart-pro">
														<div class="inner-men-cart-pro">
															<a href="single.html" class="link-product-add-cart">Quick View</a>
														</div>
								...
								<div class="gd-box-info text-center">
									<div class="product-men women_two bot-gd">
										<div class="product-googles-info slide-img googles">
											<div class="men-pro-item">
												<div class="men-thumb-item">
													<img src="static/images/receptionImg/s8.jpg" class="img-fluid" alt="">
													<div class="men-cart-pro">
														<div class="inner-men-cart-pro">
															<a href="single.html" class="link-product-add-cart">Quick View</a>
														</div>
								...
								<div class="gd-box-info text-center">
									<div class="product-men women_two bot-gd">
										<div class="product-googles-info slide-img googles">
											<div class="men-pro-item">
												<div class="men-thumb-item">
													<img src="static/images/receptionImg/s9.jpg" class="img-fluid" alt="">
													<div class="men-cart-pro">
														<div class="inner-men-cart-pro">
															<a href="single.html" class="link-product-add-cart">Quick View</a>
														</div>
								...
								<div class="gd-box-info text-center">
									<div class="product-men women_two bot-gd">
										<div class="product-googles-info slide-img googles">
											<div class="men-pro-item">
												<div class="men-thumb-item">
													<img src="static/images/receptionImg/s10.jpg" class="img-fluid" alt="">
													<div class="men-cart-pro">
														<div class="inner-men-cart-pro">
															<a href="single.html" class="link-product-add-cart">Quick View</a>
														</div>
				...
				<div class="row galsses-grids pt-lg-5 pt-3">
					<div class="col-lg-6 galsses-grid-left">
						<figure class="effect-lexi">
							<img src="static/images/receptionImg/banner4.jpg" alt="" class="img-fluid">
							<figcaption>
								<h3>Editor's
									<span>Pick</span>
								</h3>
					...
					<div class="col-lg-6 galsses-grid-left">
						<figure class="effect-lexi">
							<img src="static/images/receptionImg/banner1.jpg" alt="" class="img-fluid">
							<figcaption>
								<h3>Editor's
									<span>Pick</span>
								</h3>
	...
	<footer class="py-lg-5 py-3">
		<div class="container-fluid px-lg-5 px-3">
			...
			<div class="copyright-w3layouts mt-4">
				<p class="copy-right text-center ">Copyright &copy; 2018.Company name All rights reserved.</p>
			</div>
		</div>
	</footer>
	<!-- //footer -->
	...
	<!--jQuery-->
	<script src="static/js/receptionPage/jquery-2.2.3.min.js"></script>
	<!-- newsletter modal -->
	<!-- Modal -->
	<!-- Modal -->
	...
	<!--search jQuery-->
	<script src="static/js/receptionPage/modernizr-2.6.2.min.js"></script>
	<script src="static/js/receptionPage/classie-search.js"></script>
	<script src="static/js/receptionPage/demo1-search.js"></script>
	<!--//search jQuery-->
	<!-- cart-js -->
	<script src="static/js/receptionPage/minicart.js"></script>
	<script>
		googles.render();
	...
	<!-- carousel -->
	<!-- Count-down -->
	<script src="static/js/receptionPage/simplyCountdown.js"></script>
	<link href="static/css/receptionCss/simplyCountdown.css" rel='stylesheet' type='text/css' />
	<script>
		var d = new Date();
	...
	<!--// Count-down -->
	<script src="static/js/receptionPage/owl.carousel.js"></script>
	<script>
		$(document).ready(function () {
	...
	<!-- //dropdown nav -->
  <script src="static/js/receptionPage/move-top.js"></script>
    <script src="static/js/receptionPage/easing.js"></script>
    <script>
	...
	<script src="static/js/receptionPage/bootstrap.js"></script>
	<!-- js file -->
</body>
</html>